...
public class AppSettingsDialog {
    ...
    private AppSettingsDialog(@NonNull final Object activityOrFragment, @NonNull final Context context, @NonNull String rationale, @Nullable String title, @Nullable String positiveButton, @Nullable String negativeButton, @Nullable DialogInterface.OnClickListener negativeListener, int requestCode) {
        ...
        final int settingsRequestCode =
                requestCode > 0 ? requestCode : DEFAULT_SETTINGS_REQ_CODE;
